...
PKGDIR="prometheusListener-1.03.00-0_amd64"

mkdir -p ${PKGDIR}/opt/sbin ${PKGDIR}/DEBIAN ${PKGDIR}/etc/systemd/system ${PKGDIR}/etc/prometheus
...
touch ${PKGDIR}/etc/prometheus/prometheusListener.json
dpkg-deb -b ${PKGDIR}
